...
class HomePage {
    ...
    constructor(afAuth, afs, geolocation, sqlite, http) {
        this.afAuth = afAuth;
        this.afs = afs;
    ...
    openDB() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (window.cordova.platformId === 'browser') {
                var db = yield window.openDatabase('garages', '1.0', 'Data', 2 * 1024 * 1024);
    ...
    initDB() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            var script = yield this.http.get('../../assets/garages.sql', { responseType: 'text' }).toPromise();
            var commands = script.split(";");
            if (window.cordova.platformId === 'browser') {
                for (var command of commands) {
                    yield this.execSQL(command);
                }
    ...
    getGarageIds() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var results = yield this.execSQL('SELECT garageID FROM Garage');
    ...
    getGarageAddress(garageID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var results = yield this.execSQL('SELECT address FROM Garage WHERE garageID = ' + garageID);
            if (results instanceof Array) {
